...
APP_NAME=nagapetyan
API_DIR=./nagapetyan-api
WEB_DIR=./nagapetyan-web
DOMAIN=nagapetyan.danbel.ru
...
mkdir -p release
cp ./build/libs/nagapetyan-api-0.0.1-SNAPSHOT.jar ./release/nagapetyan-api-0.0.1-SNAPSHOT.jar
...
ssh $SERVER '
  ...
  cd /opt
  docker compose up nagapetyan-api -d --build
'
